...
$supportEmail = 'nptestidmail@gmail.com';

/*if($_SERVER['SERVER_NAME'] == 'namasteyoga.inroad.in') {
    $supportEmail = 'nptestidmail@gmail.com';
} else {
...
return [
    ...
    */
    ...
    'from' => [
        ...
        'address' => env('MAIL_FROM_ADDRESS', 'nptestidmail@gmail.com'),
        'name' => env('MAIL_FROM_NAME', 'Namaste-Yoga'),
    ],
