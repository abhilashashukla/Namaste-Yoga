...
class RatingController extends Controller
{
    ...
    public function addRating(Request $request){
        try{
            ...
            if($flag){
                return response()->json(['status'=> Config::get('app.status_codes.NP_STATUS_SUCCESS'),'message'=>"",'data'=>$rating]);
            }else{
                return response()->json(['status'=> Config::get('app.status_codes.NP_STATUS_FAIL'),'message'=>$type.' rating not recorded','data'=>[]]);        
            }
