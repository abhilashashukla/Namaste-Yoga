             ...
             else
             {
               ...
               // $storage_path=asset('/public/images/social_media');
                ...
                foreach($social_media_list as $social_media)
                {
                   ...
                   [
                         "id"=>$social_media->id,
                         "organization_name"=>$social_media->organization_name,
                         "org_facebook"=>$social_media->org_facebook,
                         "org_twitter"=>$social_media->org_twitter,
                         "org_instagram"=>$social_media->org_instagram,
                         "org_youtube"=>$social_media->org_youtube,
                         "org_other"=>$social_media->org_other,
