...
class AasanaCategory extends Controller
{
   ...
   /**
    ...
    public function SaveCategory(Request $request)
    {
        $user  = Auth::user()->id;
               $rules = [   
                    'category_name' => 'required|max:150|unique:aasana_categories,category_name',
					//'category_name' => 'unique:aasana_categories,category_name',
            ...
            else
            {
                ...
                ['category_name'=>ucwords(trim($request->category_name)),
                ...
                if($result)
                {
					return redirect()->action('AasanaCategory@ListCategory')->with('success', 'Aasana Category Added successfully');
                   // return back()->with('success', 'Aasana Category Added successfully');
                }
                else
                {
					return back()->withErrors(['errors'=>'Failed to add Aasana Category']);
    ...
    public function ChangeCategoryStatus(Request $request){
        try{
		 ...
		 // $categoryData = $subcategory->findOrFail($id);
		/*  $subcategorydata=AasanaSubCategory::where('aasana_sub_categories',$id)->where('status','1')->get();
         echo "<pre>";
      ...
      public function ViewCategory(Request $request)
      {
			...
			{
				return redirect()->action('AasanaCategory@ListCategory')->with('flash_message_for_aasana_category_view', 'Aasana category not available')->with('flash_type', 'alert-danger'); 
			}
      ...
      public function EditCategory(Request $request)
      {
		...
		{
				return redirect()->action('AasanaCategory@ListCategory')->with('flash_message_for_aasana_category_edit', 'Aasana category not available')->with('flash_type', 'alert-danger'); 
		}
     }
            ...
            $validator = Validator::make($request->all(),[
                ...
                /*  [
                  ...
                  'category_description.required'=>'Please enter category description',
                   'category_image.required'=>'Please jpeg,png,jpg category Image',
