       ...
       if ($request->isMethod('post')) {
           ...
           if(isset($userData) && $userData->count()){ 
			   if($request->captcha==''){
                ...
                return redirect()->back()->withErrors(['empty_captcha'=>'Please enter captcha.']); 
               }
               if($value!= $request->captcha){
                  
                return redirect()->back()->withErrors(['invalid_captcha'=>'Please enter correct captcha.']); 
               }
