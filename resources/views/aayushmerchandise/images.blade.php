...
<div class="right_col clearfix" role="main">
  ...
  <div class="col-md-12 col-xs-12">
    ...
    @endif
        <div class="x_panel">
            <div class="x_title">
                <h2>Upload Category and Product Images</h2>
                <div class="clearfix"></div>
            </div>
            <br>
            <div class="x_content">
              <div id="errr_msg"></div>
                <form class="form-horizontal form-label-left cat_prodct_img" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12 newfile">
                          <div id="loader"></div>
                            <input type="file" class="form-control" id="file_image" multiple accept="image" name="file_image[]" />
...
$(document).ready(function(){
  ...
  //   if($(this).val() == 1){
  //     $('.newfile').html('<input type="file" class="form-control" id="file_image" accept="image" name="file_image" /><span>image size should be 2 MB.</span>');
  //   }else if ($(this).val() == 2){
  //     $('.newfile').html('<input type="file" class="form-control" id="file_image" accept="image" name="file_image[]" multiple /><span>image size should be 2 MB.</span>');
  //   }else{
  //     $('.newfile').html('<input type="file" class="form-control" id="file_image" accept="image" name="file_image" /><span>image size should be 2 MB.</span>');
  //
  //   }
  // })
    $(".import_btn").click(function () {
        var tainerform = $(".cat_prodct_img")[0]
            ...
            success: function (data) {
              ...
              $('#alertBox').modal('show');
                if(data.success == true){
                  ...
                  window.setTimeout(function(){
                  location.href = '/aayushproductlist';
                  }, 3000);
                }
