  ...
  <div class="col-md-12 col-xs-12">
      ...
      @endif
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left disableonsubmit" action="{{ route('quiz.store')}}" method="POST">
                      {{ csrf_field() }}
					...
					<div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input class="form-control" placeholder="Valid For" type="number" name="valid_for" id="valid_for" min="1" max="365">
                        </div>
                      </div>
