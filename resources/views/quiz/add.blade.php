...
@endif
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left disableonsubmit" action="{{ url('/quiz/storeQuestions')}}" method="POST">
                      {{ csrf_field() }}
					  ...
					  <div class="dynamicFields">
						  ...
						  <div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12 radio-txtbox-row">							
									  <input class="form-check-input answer_0" type="radio" name="answer[0]" value="0" title="Choose Correct Answer">		
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12 radio-txtbox-row">							
									  <input class="form-check-input answer_0" type="radio" name="answer[0]" value="1" title="Choose Correct Answer">		
						  ...
						  <div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12 radio-txtbox-row">							
									  <input class="form-check-input answer_0" type="radio" name="answer[0]" value="2" title="Choose Correct Answer">							
						  ...
						  <div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12 radio-txtbox-row">							
									  <input class="form-check-input answer_0" type="radio" name="answer[0]" value="3" title="Choose Correct Answer">			
