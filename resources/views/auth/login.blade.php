...
<html lang="en">
  <head>
    ...
    <script src="{{ url('/') }}/vendors/jquery/dist/jquery-3.6.0.min.js"></script>
    <script src="{{ url('/') }}/vendors/jquery/dist/jquery-migrate-3.3.2.min.js"></script>
          ...
          <section class="login_content">
            ...
            <form class="form-horizontal" autocomplete="off" id="loginForm" role="form" method="POST" action="{{ route('login') }}">
              ...
              @if ($errors->has('captcha'))
                <span class="help-block text-left alert alert-danger">
                  <strong>
              ...
              @endif
              @if ($errors->has('empty_captcha'))
                <span class="help-block text-left alert alert-danger">
                  <strong>
                        {{ $errors->first('empty_captcha') }}
                  </strong>                        
                </span>        
              @endif
