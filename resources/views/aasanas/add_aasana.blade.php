...
<div class="right_col clearfix" role="main">
  ...
  <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" action="{{ url('/aasana/saveaasana') }}" method="POST" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <input class="form-control" type="text" name="aasana_name" placeholder="Aasana Name" value="{{ old('aasana_name') }}"/>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <textarea class="form-control" rows="3" name="aasana_description" placeholder="Aasana Description">{{{ old('aasana_description') }}}</textarea>
                      ...
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" placeholder="Upload Image" type="file" name="aasana_image">
                        </div>
                      </div> -->
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tags</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <input class="form-control" type="text" name="assana_tag" placeholder="Aasana Tags" value="{{ old('assana_tag') }}" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <input class="form-control" type="text" name="assana_video_id" placeholder="Aasana Video Path" value="{{ old('assana_video_id') }}"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Video Duration</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <input class="form-control" type="text" name="assana_video_duration" placeholder="Aasana Video Duration" value="{{ old('assana_video_duration') }}"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Benefits</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <textarea class="form-control" rows="2" name="assana_benifits" placeholder="Aasana Benefits">{{{ old('assana_benifits') }}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <textarea class="form-control" rows="2" name="assana_instruction" placeholder="Aasana Instructions">{{{ old('assana_instruction') }}}</textarea>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                          ...
                          <button type="submit" class="btn btn-success submitAasana">Submit</button>
                        </div>
                      </div>
...
<script>
 $('body').on('click','.submitAasana',function(){
    ...
    let assana_benifits = $("input[name=assana_benifits]").val();
    if(assana_benifits==''){
			$("input[name=assana_benifits]").css('border','red 1px solid').attr('placeholder','Please enter aasana benifits');
			return false;
		}
