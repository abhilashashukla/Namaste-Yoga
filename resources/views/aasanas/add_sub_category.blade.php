...
<div class="right_col clearfix" role="main">
  ...
  <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Aasanas Sub Category</h2>

                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" action="{{ url('/aasana/savesubcategoy') }}" method="POST" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          @foreach($categorylist as $category)
                             <option value="{{ $category->id}}" @if($category->id==old('aasana_categories_id')) selected @endif>{{ $category->category_name}}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" placeholder="Sub Category Name" type="text" name="subcategory_name" value="{{ old('subcategory_name') }}"/>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">                       
                        <textarea class="form-control" rows="3" name="subcategory_description" placeholder="Sub Category Description">{{{ old('subcategory_description') }}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" placeholder="Upload Image" type="file" name="subcategory_image">
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                          ...
                          <button type="submit" class="btn btn-success submitSubCategory">Submit</button>
                        </div>
                      </div>
