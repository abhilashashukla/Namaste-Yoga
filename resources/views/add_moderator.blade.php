				...
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br> You have been registered for namaste yoga as moderator <a style="color:#4E9533; text-decoration:none; cursor:text;">"{{$name}}"</a> at  <a style="color:#4E9533; text-decoration:none; cursor:text;">"{{$site_name}}"</a> community!
							<br>
              <br> Below are the few details.
              <br>
              <br>Username:<a style="color:#4E9533; text-decoration:none; cursor:text;">"{{$email}}"</a>
							<br>Password:<a style="color:#4E9533; text-decoration:none; cursor:text;">"{{$password}}"</a>
							<br>
							<br>Moderator Type:<a style="color:#4E9533; text-decoration:none; cursor:text;">"{{$moderators}}"</a>
							</br>
							<br> If, however, you did not request to create the account, do get in touch with the support team at <a style="color:#4E9533; text-decoration:none;" href="mailto: {{$supportEmail}}"> {{$supportEmail}}</a>.
							<br>
							<br>
							<br> Regards,
