...
<div class="right_col" role="main">
  ...
  <div class="row tile_count">
    <div class="col-md-3 col-sm-3 col-xs-9 tile_stats_count">
      <span class="count_top"><i class="fa fa-users"></i> Total Trainer</span>
      <div class="count">{{$trainer}}</div>
      <!-- <span class="count_bottom"><i class="green">4% </i> From last Week</span> -->
    </div>    
    <div class="col-md-3 col-sm-3 col-xs-9 tile_stats_count">
      <span class="count_top"><i class="fa fa-users"></i> Approved Trainer</span>
    ...
    <div class="col-md-3 col-sm-3 col-xs-9 tile_stats_count">
      <span class="count_top"><i class="fa fa-calendar"></i> Approved Events</span>
