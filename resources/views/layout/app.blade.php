...
<html lang="{{ config('app.locale') }}">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <footer style="margin-left:0px !important" class="clearfix">
          <div class="pull-right">
            Copyright &copy; {{date('Y')}} <a href="http://namaste-yoga.ayush.gov.in">namaste-yoga.ayush.gov.in</a>			
          </div>
    ...
    function fieldValidation(fieldId,  validationType = 'alphaNumSpaceHyphen') {
        $('#'+fieldId).keypress(function (e) {
            let regex;
            if(validationType === 'alphaNumSpaceHyphen') {
