  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-users"></i>Aasanas<span class="fa fa-chevron-down"></span></a>
        ...
        <li><a><i class="fa fa-users"></i>Aasana Sub Category<span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">          
          <li><a href="{{ url('/') }}/aasana/listcategory">View Sub Category</a></li>
          <li><a href="{{url('/')}}/aasana/addcategory">Add New Sub Category</a></li>                          
        </ul>
        </li>

          <li><a href="{{ url('/') }}/users/rejected">Aasanas</a></li>                  
        </ul>
      </li> 
      @else(Auth::user()->moderator_id==6)
  <li><a><i class="fa fa-users"></i> Manage Polls<span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
