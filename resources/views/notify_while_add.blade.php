	...
	<tr>
		<td>
            ...
            <table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
              ...
              <br>A new <a style="color:#4E9533; text-decoration:none;" href="">{{$type}}</a> has been listed in <a style="color:#4E9533; text-decoration:none;" href="">{{$city_name}}</a>.
              <br>
              Please view the details on the app.

              <br>
              <br>
							<br> If, however, you did not request to this notifiacation, do get in touch with the support team at <a style="color:#4E9533; text-decoration:none;" href="mailto: {{$supportEmail}}"> {{$supportEmail}}</a>.
							<br>
							<br>
							<br> Regards,
