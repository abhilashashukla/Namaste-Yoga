  ...
  <div class="col-md-12 col-xs-12">
      ...
      @endif
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left disableonsubmit" action="{{ route('polls.store')}}" method="POST">
                      {{ csrf_field() }}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Poll Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" placeholder="Poll Name" type="text" name="poll_name" value="{{ old('poll_name') }}"/>
                        </div>
                      </div>
